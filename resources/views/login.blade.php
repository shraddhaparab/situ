        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @if (Auth::guest())
                    <li><a href="{{ url('/login') }}" onclick="changelabel();">Staff Login</a></li>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                      <label for="fname" class="control-label" id="uname">PAN Number</label>
                      
                      
                      
                      
                        <input type="text" class="form-control" id="fcp">
                  </div>
                </div>
              </div>
               ...
               <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label class="control-label" for="fadd">Password</label>
                 ...
                 <i class="fa fa-user"><br></i>Sign In</button></center>
 </div>
          </form>
</div>
        </div>
